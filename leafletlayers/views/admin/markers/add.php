...
<form class="form-valid" action="admin-post.php" id="leafletlayers_madd" method="post" name="leafletlayers_madd">
		...
		<tbody>
			...
			<td colspan="2">
			    ...
			    <input type="hidden" name="action" value="leafletlayers_add_marker">
